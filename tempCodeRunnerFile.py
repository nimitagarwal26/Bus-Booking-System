    ...
    if booked_bus_id=='None':
        ...
        def confirm():
            ...
            if answer:
                ...
                con=sqlite3.connect('bus_reservation_211b197')
                cur=con.cursor()
                cur.execute('''insert into booking_history (pname,gender,age,mobile,bus,travelling_date,booking_date,no_of_seats) values (?,?,?,?,?,?,DATE(),?)''',(name,gender,age,mob,booked_bus_id,T_date,nos))
